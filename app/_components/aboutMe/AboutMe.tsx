          ...
          <div className="h-full p-2">
            ...
            <div className="flex gap-2">
              <motion.span
                ...
                className="block font-extrabold text-[75px] text-blue-500 md:text-[115px] lg:text-[150px] leading-[70px] md:leading-20 lg:leading-36"
              >
                Me
              </motion.span>
            ...
            <motion.div variants={parentVariant} initial="hidden" animate="visible">
              <motion.p
                ...
                className="font-bold md:hidden text-sm text-[#0f172a] my-1 flex gap-2"
              >
...
const Paragraph: FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <motion.p variants={childVariant} className="text-gray-500 mt-1.5 flex gap-2">
      {children}
    </motion.p>
  );
};
